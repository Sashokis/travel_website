        ...
        <div id = "footer_" className="footer__content center">
            <div className="footer__info">
                ...
                <nav className="footer__item">
                    ...
                    <a className="footer__link" href="#catalog">Каталог</a>
                </nav>

                <div className="footer__item">
                    <h4 className="footer__heading">Контакты</h4>
                    <a className="footer__link" href="#">+7 900 800 90 80</a>
                    <a className="footer__link" href="#">airtripp@help.com</a>
                    <div className="footer__icon">
                        <a href="#">
                            <img className = "footer__icon_social" src="img/icons/Instagram.png" width="24" height="25" alt="logo" />
                        </a>
                        <a href="#">
                            <img className = "footer__icon_social" src="img/icons/Facebook.png" width="24" height="25" alt="logo" />
                        </a>
                        <a href="#">
                            <img className = "footer__icon_social" src="img/icons/Vector.png" width="24" height="25" alt="logo" />
                        </a>
